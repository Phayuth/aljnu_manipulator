...
from yolo_centroid import CVYOLOCentroid
from single_fixed_orientation import SingleFixedOrientationGraspPose
...
class PerceptionNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.yoloWeightDir = self.get_parameter("weight").get_parameter_value().string_value
        self.topicImageSub = self.get_parameter("image_topic").get_parameter_value().string_value
        self.topicPointCloudSub = self.get_parameter("pcd_topic").get_parameter_value().string_value
        self.topicMaskPub = self.get_parameter("mask_topic").get_parameter_value().string_value
        self.topicGraspPub = self.get_parameter("grasp_topic").get_parameter_value().string_value
        self.graspLink = self.get_parameter("grasp_link").get_parameter_value().string_value
        ...
        self.cvc = CVYOLOCentroid(self.yoloWeightDir, interestNames=[self.get_parameter("pick_object").get_parameter_value().string_value])
